...
| Orchestration | **LangGraph**                   | `analysis_graph.py`, `strategy_graph.py` — wires LLM nodes, not LLM itself      |
...
- Full profile scales to full manifest (API/env); dev profile stays fast and mode-targeted
